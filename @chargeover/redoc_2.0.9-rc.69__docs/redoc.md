...
[* ← Back to Docs](/docs)[* Redoc Community Edition](/docs/redoc)[* Quickstart](/docs/redoc/deployment/html)[* Configuration](/docs/redoc/config)[* Deployment guides](/docs/redoc/deployment/intro)[* Vendor extensions](/docs/redoc/redoc-vendor-extensions)Last updated  5 days ago
...
* Using [Redocly CLI](/docs/cli), configuration goes in the `redocly.yaml` file, or can be supplied as command line parameters, such as `--theme.openapi.disableSearch`.
...
There are many, many more options available. Visit the [configuration reference](/docs/redoc/config) for a complete list.

Next steps
----------

* If you are new to OpenAPI, try the [OpenAPI starter project](/docs/cli/openapi-starter) for a great introduction.
* Ready to build documentation from an existing OpenAPI file? Go to the [Redoc quickstart](/docs/redoc/deployment/html) and get started.
* Learn more about the project by visiting [Redoc on GitHub](https://github.com/Redocly/redoc).
#### Was this helpful?

 Next pageOn this page[Headline features](#headline-features)[Demo](#demo)[Usage](#usage)[Generate documentation from the CLI](#generate-documentation-from-the-cli)[Add an HTML element to the page](#add-an-html-element-to-the-page)[More usage options](#more-usage-options)[Configure Redoc](#configure-redoc)[Next steps](#next-steps)
