...
[* ← Back to Docs](/docs)[* Redoc Community Edition](/docs/redoc)[* Quickstart](/docs/redoc/deployment/html)[* Configuration](/docs/redoc/config)[* Deployment guides](/docs/redoc/deployment/intro)[* Vendor extensions](/docs/redoc/redoc-vendor-extensions)Last updated  3 months ago
...
You can inject the Security Definitions widget into any place in your definition `description`. For more information, refer to [Security definitions injection](/docs/redoc/security-definitions-injection).

### OpenAPI specification extensions

Redoc uses the following [specification extensions](https://redocly.com/docs/api-reference-docs/spec-extensions/):

* [`x-logo`](/docs/redoc/redoc-vendor-extensions#x-logo) - is used to specify API logo
* [`x-traitTag`](/docs/redoc/redoc-vendor-extensions#x-traittag) - useful for handling out common things like Pagination, Rate-Limits, etc
* [`x-codeSamples`](/docs/redoc/redoc-vendor-extensions#x-codesamples) - specify operation code samples
* [`x-examples`](/docs/redoc/redoc-vendor-extensions#x-examples) - specify JSON example for requests
* [`x-nullable`](/docs/redoc/redoc-vendor-extensions#x-nullable) - mark schema param as a nullable
* [`x-displayName`](/docs/redoc/redoc-vendor-extensions#x-displayname) - specify human-friendly names for the menu categories
* [`x-tagGroups`](/docs/redoc/redoc-vendor-extensions#x-taggroups) - group tags by categories in the side menu
* [`x-servers`](/docs/redoc/redoc-vendor-extensions#x-servers) - ability to specify different servers for API (backported from OpenAPI 3.0)
* [`x-ignoredHeaderParameters`](/docs/redoc/redoc-vendor-extensions#x-ignoredheaderparameters) - ability to specify header parameter names to ignore
* [`x-additionalPropertiesName`](/docs/redoc/redoc-vendor-extensions#x-additionalpropertiesname) - ability to supply a descriptive name for the additional property keys
* [`x-summary`](/docs/redoc/redoc-vendor-extensions#x-summary) - For Response object, use as the response button text, with description rendered under the button
* [`x-extendedDiscriminator`](/docs/redoc/redoc-vendor-extensions#x-extendeddiscriminator) - In Schemas, uses this to solve name-clash issues with the standard discriminator
* [`x-explicitMappingOnly`](/docs/redoc/redoc-vendor-extensions#x-explicitmappingonly) - In Schemas, display a more descriptive property name in objects with additionalProperties when viewing the property list with an object
#### Was this helpful?

 Next pageOn this page[Functional settings](#functional-settings)[disableSearch](#disablesearch)[minCharacterLengthToInitSearch](#mincharacterlengthtoinitsearch)[expandDefaultServerVariables](#expanddefaultservervariables)[expandResponses](#expandresponses)[expandSingleSchemaField](#expandsingleschemafield)[hideDownloadButton](#hidedownloadbutton)[hideHostname](#hidehostname)[hideLoading](#hideloading)[hideRequestPayloadSample](#hiderequestpayloadsample)[hideOneOfDescription](#hideoneofdescription)[hideSchemaPattern](#hideschemapattern)[hideSchemaTitles](#hideschematitles)[hideSecuritySection](#hidesecuritysection)[hideSingleRequestSampleTab](#hidesinglerequestsampletab)[htmlTemplate](#htmltemplate)[jsonSampleExpandLevel](#jsonsampleexpandlevel)[maxDisplayedEnumValues](#maxdisplayedenumvalues)[menuToggle](#menutoggle)[nativeScrollbars](#nativescrollbars)[onlyRequiredInSamples](#onlyrequiredinsamples)[pathInMiddlePanel](#pathinmiddlepanel)[payloadSampleIdx](#payloadsampleidx)[requiredPropsFirst](#requiredpropsfirst)[schemaExpansionLevel](#schemaexpansionlevel)[scrollYOffset](#scrollyoffset)[showExtensions](#showextensions)[showObjectSchemaExamples](#showobjectschemaexamples)[showWebhookVerb](#showwebhookverb)[simpleOneOfTypeLabel](#simpleoneoftypelabel)[sortEnumValuesAlphabetically](#sortenumvaluesalphabetically)[sortOperationsAlphabetically](#sortoperationsalphabetically)[sortPropsAlphabetically](#sortpropsalphabetically)[sortTagsAlphabetically](#sorttagsalphabetically)[untrustedDefinition](#untrusteddefinition)[Theme settings](#theme-settings)[Additional customization](#additional-customization)[Security Definition location](#security-definition-location)[OpenAPI specification extensions](#openapi-specification-extensions)
