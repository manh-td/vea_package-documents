...
[Ghost 0.5.4](https://github.com/TryGhost/Ghost/releases/tag/0.5.4?ref=ghost.org) is now available on GitHub, npm and Ghost.org. 0.5.4 is a maintenance release featuring a very important fix for a memory leak affecting 0.5.3, which causes Ghost to become unstable and crash under heavy load. This update also includes a number of more minor improvements and bug fixes.
...
As well as many other improvements. You can see the [full change log](https://gist.github.com/ErisDS/0762e69b7c9015288e26?ref=ghost.org) for the full details of every change included in this release.
