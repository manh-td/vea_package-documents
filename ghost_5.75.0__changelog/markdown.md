...
It’s no secret that we’re big fans of **Markdown** at [Ghost](https://ghost.org/?ref=ghost.org). We built our editor to work with Markdown directly!
...
The *quick* brown fox, jumped **over** the lazy [dog](https://en.wikipedia.org/wiki/Dog?ref=ghost.org).
...
Here’s the one you can pull up from the [Ghost](https://ghost.org/?ref=ghost.org) editor at any time if you get stuck.
...
**The quick brown [fox](https://en.wikipedia.org/wiki/Fox?ref=ghost.org), jumped over the lazy [dog](https://en.wikipedia.org/wiki/Dog?ref=ghost.org).**
...
Now we're going to look at some syntax which is **not standard** to native Markdown. They're extensions of the language. All of these things work in [Ghost](https://ghost.org/?ref=ghost.org), but they may not work in other editors.
...
[https://ghost.org](https://ghost.org/?ref=ghost.org)
...
Combined with [Prism.js](https://prismjs.com/?ref=ghost.org) in the Ghost theme:
...
![](https://ghost.org/changelog/content/images/2021/01/image-131.png)
...
* [iA Writer](https://ia.net/writer?ref=ghost.org) - $19.99
* [ByWord](https://bywordapp.com/?ref=ghost.org) - $11.99
* [Day One](https://dayoneapp.com/?ref=ghost.org) - $9.99
* [SublimeText](https://www.macstories.net/roundups/sublime-text-2-and-markdown-tips-tricks-and-links/?ref=ghost.org) - $70

### Windows PC Markdown Editors

![](https://ghost.org/changelog/content/images/2021/01/image-132.png)
...
* [WriteMonkey](https://writemonkey.com/index.php?ref=ghost.org) - Free
* [MarkdownPad](https://markdownpad.com/?ref=ghost.org) - Free + $14.99 Pro version
* [SublimeText](https://www.macstories.net/roundups/sublime-text-2-and-markdown-tips-tricks-and-links/?ref=ghost.org) - $70

### Apple iOS Markdown Apps

![](https://ghost.org/changelog/content/images/2021/01/image-133.png)
...
* [Werdsmith](https://werdsmith.com/?ref=ghost.org) - Free
* [iA Writer](https://ia.net/writer?ref=ghost.org) - $9.99
* [ByWord](https://bywordapp.com/?ref=ghost.org) - $5.99
* [Day One](https://dayoneapp.com/?ref=ghost.org) - $4.99

### Google Android Markdown Apps

![](https://ghost.org/changelog/content/images/2021/01/image-134.png)
...
* [Jotterpad X](https://play.google.com/store/apps/details?id=com.jotterpad.x&ref=ghost.org) - Free
* [Writer](https://play.google.com/store/apps/details?id=com.jamesmc.writer&ref=ghost.org) - Free
* [iA Writer](https://ia.net/writer?ref=ghost.org) - $5.99

Publishing Online with Markdown
-------------------------------

![](https://ghost.org/changelog/content/images/2021/01/image-135.png)

**Markdown based blogging is kind of what we specialise in!** If you're looking for a blog with a comprehensive Markdown editor. [Ghost](https://ghost.org/?ref=ghost.org) might be exactly what you need for beautiful, simple publishing.
