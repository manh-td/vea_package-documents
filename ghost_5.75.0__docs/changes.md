...
The [update guide](/docs/update/) explains how to update from Ghost 1.0 or higher to the **latest version**. Ghost(Pro) customers should use the [update guide for Ghost (Pro)](/help/how-to-upgrade-ghost/).
...
* The Apps beta concept has been removed. Use the Core APIs & [integrations](/integrations/) instead.
...
* See [announcement post](/changelog/1-0/) and [developer details](/changelog/ghost-1-0-0/) for full information on what we changed in 1.0.
