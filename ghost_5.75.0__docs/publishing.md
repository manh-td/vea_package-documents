...
You can see this use-case in action on the main Ghost blog. Here’s [a regular post](/changelog/image-galleries/), and here’s a [#feature](/changelog/5/). The design of the post reacts to the tags.
