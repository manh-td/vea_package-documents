...
Ghost charges 0% transaction fees. Your Ghost site is connected directly to your own Stripe account and we don't charge any extra transaction fees. The only fees you'll need to pay are Stripe's own processing fees (2.9% + 30¢). Beyond that, all of your revenue is yours to keep.

Find out how this compares to [other platforms](https://ghost.org/alternatives/?ref=ghost.org).
