...
Does Ghost automatically back up my data?
...
If you need to export your data for any reason, you can grab a quick export of your content, members, themes, and post analytics from Ghost admin — read more about [generating exports](https://ghost.org/help/exports/) of your data.  
  
Outside of using the on-demand export options, developers can utilize the [Admin API](https://ghost.org/docs/admin-api/) and [Content API](https://ghost.org/docs/content-api/) to write scripts and pull down data to be stored locally or on your own server.

Full site archives
------------------

You can also request a complete site archive, including images. Ghost(Pro) archives are not provided for service continuity and are not provided as backups. These archives are provided for the following purposes:

* closing a site — if it's time to take the site down, but you'd like to retain the data, we will provide an archive
* migrating a site — we can provide a complete archive to help you move your site away from Ghost(Pro)
* creating a second Ghost instance for staging — when you're planning a big redesign of a site, it can be helpful to run a local Ghost site with some placeholder content

If you need an archive for these purposes please contact [support@ghost.org](mailto:support@ghost.org).

⚠️Full site archives cannot be provided for Ghost(Pro) accounts that have already been cancelled.
