...
Can I run a headless site with Ghost(Pro)?
...
Ghost(Pro) can be used as a Headless CMS with other third-party front-end frameworks, such as NextJS and Gatsby for example. Setup guides for the most popular frameworks can be found in our [developer documentation](https://ghost.org/docs/jamstack/).
...
* “View in Browser” links contained in email newsletter templates will always lead to the [ghost.io](http://ghost.io) site
* Unsubscribe links contained in email newsletters will always lead to the [ghost.io](http://ghost.io) site
* A headless setup requires a custom theme, to not expose content to search. You can find an example of a theme for use with a headless setup [here](https://github.com/ShortTechDE/headless-placeholder).
* You will not benefit from Ghost(Pro)’s CDN, provided via [Fastly](https://www.fastly.com/).
...
If you're unsure of the technical aspect required to setup your Ghost(Pro) site in a headless environment, checkout our [Expert Directory](https://ghost.org/experts).
