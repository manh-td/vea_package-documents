...
Can I use more than one domain with my site?
...
You can add one [custom domain](https://ghost.org/help/using-custom-domains/) to your Ghost(Pro) site. All requests for posts and pages on your site will then resolve to that domain.
