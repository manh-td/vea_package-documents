...
We, like you, expect our data to be secure and confidential at all times, and we go to great lengths to ensure that this is always the case. We conduct regular security reviews of our product and infrastructure, and as an [open source codebase](https://github.com/tryghost/ghost?ref=ghost.org)—of course—we have very public scrutiny of all our practices.

All **Ghost(Pro)** servers are located in Amsterdam, The Netherlands. We have a publicly available [Data Processing Agreement](https://ghost.org/dpa/?ref=ghost.org).
