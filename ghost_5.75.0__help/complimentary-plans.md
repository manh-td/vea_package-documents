...
Give any reader access to paid content by creating a complimentary plan for their member account in Ghost.

A complimentary plan can be added to a member account by clicking the "+ Add Complimentary Subscription" link, in the Subscription settings of their profile.

You can also [import members](https://ghost.org/help/import-members/) to Ghost with a complimentary plan set to `TRUE`.

![](https://ghost.org/help/content/images/2023/04/CleanShot-2023-04-20-at-16.31.19@2x.png)
