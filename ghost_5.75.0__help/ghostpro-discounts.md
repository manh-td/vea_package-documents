...
Do you offer student, open source developer, or non-profit discounts?
...
We offer a 20% discount on [all Ghost(Pro)](https://ghost.org/pricing?ref=ghost.org) plans if you subscribe **annually**. As a non-profit organization, we aren't able to discount our services beyond the annual discount. The good news is that the entire codebase is free and open source, so you can [self-host](https://ghost.org/docs/hosting) it on your own server!

**Ghost(Pro)** is the sole source of funding for the open source project, which is how we’re able to improve Ghost and build new features.
