...
How to use Google Pay with Ghost
...
Google Pay can be enabled within your Stripe Account, in the [**Settings** → **Payment Methods**](https://dashboard.stripe.com/settings/payment_methods) area, under the Wallets options.

![](https://ghost.org/help/content/images/2022/09/enable-google-pay.png)

Expand the **Google Pay** option to toggle the feature on or off. By default, Google Pay is on automatically.

When Google Pay is enabled, a Google Pay badge appears if Stripe checkout detects the customer's device and region that supports Google Pay.

![](https://ghost.org/help/content/images/2022/09/google-pay-enabled.png)
### You’re all set!
