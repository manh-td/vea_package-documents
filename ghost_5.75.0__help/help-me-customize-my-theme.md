...
Can Ghost help me write code and customize my theme?
...
While we're not able to write code for you, you can use code injection in Ghost Admin, to inject your own custom scripts and styling into the site header.

We have a tutorial on [using code injection](https://ghost.org/tutorials/use-code-injection-in-ghost/) that can be followed for guidance if needed, as well as a [help article](https://ghost.org/help/code-injection-styles/) on usage, which contains basic examples. You can also use the [community forum](https://forum.ghost.org) if you'd like to get CSS/JS help from the Ghost community.

If you're not familiar with custom theming in Ghost, we do have an [Expert Directory](https://ghost.org/experts/) if you'd like to hire a freelancer or agency to assist in making your publication dreams come true.
