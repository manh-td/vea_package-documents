...
The history log can be accessed by staff users with a role of Administrator or higher from the **Settings → Advanced → History → View history** area, and filtered by a variety of different events using the **Filter events** drop down, giving you a granular view of the changes occurring on your publication.

You can also view events tied to specific staff users by entering the staff user name in the search bar.

![](https://ghost.org/help/content/images/2023/10/CleanShot-2023-10-17-at-10.18.46@2x.png)
