...
How do I cancel member subscriptions
...
To cancel a paid member subscription *on their behalf* immediately, you will need to navigate to the member’s Stripe Customer profile (this is accessible within their [member profile](https://ghost.org/help/member-management/#quick-access-billing-in-stripe) in Ghost Admin).
...
![](https://ghost.org/help/content/images/2024/11/stripe-cancel-subscription.png)
