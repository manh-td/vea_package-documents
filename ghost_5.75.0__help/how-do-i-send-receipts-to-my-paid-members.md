...
How do I send receipts to my paid members?
...
To enable automated receipts, you will need to login to your Stripe account, and toggle **Successful payments** on, in your [Customer emails settings](https://dashboard.stripe.com/settings/emails).
