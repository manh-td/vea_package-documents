...
Navigate to the **Members** area in Ghost Admin, click the profile of the member, then click the gear icon, and select **Impersonate** at the top-right of the page.

![](https://ghost.org/help/content/images/2023/02/impersonate-member.png)

Copy the unique single-use link and paste it into your browser's URL bar to be signed in as the member.

![](https://ghost.org/help/content/images/2023/02/impersonate-link.png)


[Next up
 →](/help/impersonate-members/)
### Related articles
