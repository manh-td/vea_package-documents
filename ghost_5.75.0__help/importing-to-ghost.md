...
Ghost has built-in tools to migrate content and subscribers from selected platforms.

* [Substack](https://ghost.org/help/importing-from-substack/)
* [WordPress](https://ghost.org/help/importing-from-wordpress/)
* [Medium](https://ghost.org/help/importing-from-medium/)
* [Mailchimp](https://ghost.org/help/importing-from-mailchimp/)

For more information about complex migrations and other platforms, please visit the [developer documentation](https://ghost.org/docs/migration/).
