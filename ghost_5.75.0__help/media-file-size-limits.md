...
When uploading media files to Ghost, while there is no limit on the number of files you can upload to your site, there is a file size limit based on your [Ghost(Pro) plan](https://ghost.org/pricing?ref=ghost.org).
...
💡If you have concerns regarding media storage on Ghost(Pro), please checkout our [Fair Usage Policy](https://ghost.org/fair-use/).
