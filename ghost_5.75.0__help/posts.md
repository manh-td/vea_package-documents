...
To create a new post, go to **Posts** from the admin menu on the left.

![](https://ghost.org/help/content/images/2023/10/CleanShot-2023-10-17-at-09.47.11.png)

From there, you can either click on the **New post** button in the top right corner of the screen, or you can click on the `+` icon from the admin menu. Once the editor launches, all you need to do is start writing ✍️
