...
![](https://ghost.org/help/content/images/2023/11/create-recommendation.png)

In the “Add recommendation” box, enter the site address you’d like to recommend to your audience, and click **Next**.

![](https://ghost.org/help/content/images/2023/11/add-recommendation.png)

You can customize the title and the description for your recommendation.

![](https://ghost.org/help/content/images/2023/11/customize-recommendation.png)
...
This URL also be copied, and used as a link in your [site navigation](https://ghost.org/help/updating-navigation/), to give readers quick access to sites you recommend. See additional methods for opening the recommendations window in our [theme documentation](https://ghost.org/docs/themes/helpers/recommendations/).
