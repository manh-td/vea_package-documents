...
How do I send a welcome email to new members?
...
Ghost automatically sends new members a confirmation email after signup, to confirm their membership to your publication. The confirmation button can be configured to link to a custom welcome page after confirming signup. Read more about setting up [custom welcome pages](https://ghost.org/help/welcome-pages).  
  
Ghost can also be integrated with several other tools via [Zapier](https://ghost.org/integrations/zapier), or using the [Admin API](https://ghost.org/docs/admin-api/), to send emails to new members.  
  
For example, you could setup a "zap" using Zapier, to add new members to a custom list with a tool like [Drip](https://ghost.org/integrations/drip), or [ConvertKit](https://ghost.org/integrations/convertkit). This would allow you to send custom welcome emails, or setup a custom email campaign for new members.
