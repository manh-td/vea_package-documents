...
Snippets allow any staff user to reuse content and cards across posts and pages.

### Creating & using snippet
...
![](https://ghost.org/help/content/images/2021/09/Kapture-2021-09-20-at-17.22.15-1.gif)

To insert a snippet into a new post, use the dynamic card menu to select your snippet or type `/{snippet title}` onto a new line of the editor.

### Deleting a snippet

To delete a snippet, you can use the dynamic card menu to view your snippet list, or type `/{snippet title}`, then hover over the snippet you want to delete with your cursor, and click on the trash can icon.

![](https://ghost.org/help/content/images/2024/09/CleanShot-2024-09-06-at-15.10.58@2x.png)
...
![](https://ghost.org/help/content/images/2021/09/replacing-snippet.png)
