...
To transfer ownership of a site, log into the site as the existing owner and navigate to the **Settings** **→ Staff** area of Ghost Admin.

Click on the staff user profile who should be made the *new* owner. From within their user profile settings, click the "..." icon in the top right corner and select **Make owner**.

⚠️Only an administrator role staff user can be made a publication owner.
