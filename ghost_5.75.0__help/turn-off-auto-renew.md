...
How do I turn off auto-renew for my Ghost(Pro) subscription?
...
To cancel your auto-renewal, the owner user must login to Ghost Admin, and navigate to the **Ghost(Pro) → Billing** area. From there, you can click on the red **Cancel account** link in the lower-left corner of the billing page to cancel the auto-renew of your Ghost(Pro) subscription.

Once your subscription is **cancelled**, your site and account will be **deleted** at the end of your billing cycle. If you need your site to be taken offline sooner, please contact support@ghost.org.

**As mentioned in our**[**terms of service**](https://ghost.org/terms/?ref=ghost.org)**, we do not offer refunds.**
