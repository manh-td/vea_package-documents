...
Authors who create and publish several articles often use `TK` as a placeholder for content which is considered still “[To Come.](https://en.wikipedia.org/wiki/To_come_(publishing)?ref=ghost.org#:~:text=%22To%20come%22%20is%20a%20printing,It%20is%20used%20without%20periods.)” This is often considered the editorial equivalent of using `//TODO` , so that you can come back to continue editing and crafting your content.
