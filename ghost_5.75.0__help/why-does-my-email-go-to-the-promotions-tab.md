...
Gmail delivers your newsletters to tabbed inboxes based on their own algorithms that consider everything, including the content of the email, subscriber engagement and sender information. It is expected that some of your newsletters will be placed in the promotions tab by Gmail.

Read more about how to influence where your emails are placed in our [deliverability tips article](https://ghost.org/help/deliverability-tips).
