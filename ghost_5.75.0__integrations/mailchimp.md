Official Ghost + Mailchimp Integration
Common searches
...
When using the [members feature](/features/) in Ghost, you might want to import an existing list of subscribers from your Mailchimp account. This is entirely possible using CSV imports.

In your Mailchimp account, navigate to the [Audience](https://us1.admin.mailchimp.com/audience/) tab, and apply any filters necessary to locate the list of emails you’d like to import to Ghost members. Once you’re done, click “Export audience”. Read more about exports in Mailchimp in their [help docs](https://mailchimp.com/help/view-export-contacts/).
...
![](/images/integrations/mailchimp-form_hub5128ec86aa8235a7b39427d5695c9ba_398347_2000x0_resize_q100_h2_box_3.webp)
...
It’s also possible to use the Mailchimp [RSS-to-Email](https://mailchimp.com/features/rss-to-email/) feature to generate automated newsletters of your latest content on Ghost, directly to your subscribers!

Once you’ve created a new campaign, enter the RSS feed which you’d like to use to populate your newsletter content. Don’t forget: You can add `/rss/` to most URLs in Ghost to get a custom RSS feed. Here are some demo examples:
...
![](/images/integrations/mailchimp-rss_hu040f20b0132c54cfa843f536380deb9a_77039_1412x0_resize_q100_h2_box_3.webp)
