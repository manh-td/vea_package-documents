...
![](https://ghost.org/resources/content/images/2021/09/portal-signup-1000.png)
...
![](https://ghost.org/resources/content/images/2023/10/CleanShot-2021-09-30-at-17.03.46@2x.png)

****Settings**** → ****Membership**** → ****Portal**** → ****Portal settings**** → ****Customize****
...
1. Subscribers become registered members, so you can choose to restrict access to posts and pages and make them accessible to members only.
2. All members sign in using secure email authentication links, so there are no passwords to set or forget, and you don't need to worry about spam.
3. With just a few clicks, you can send any post as an email newsletter to all or only a segment of your members.
4. Once visitors become members, you'll get insightful data about which posts they've read and which emails they've opened.
...
Like this: [Subscribe to the Ghost newsletter here](https://ghost.org/resources/#/portal/signup)!

> **Social networks go in and out of fashion all the time. Email addresses are timeless.**

---

Now that you've started thinking about growing your audience, let's take a look at how you can seamlessly deliver new content by [**sending new posts as email newsletters**](https://ghost.org/resources/sending-email-newsletters).
...
How to setup your Ghost publication](/resources/how-to-setup-your-ghost-publication/)
